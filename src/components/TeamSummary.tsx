  ...
  return (
    <div className="w-full p-2 md:w-2/5">
      ...
      <section className="flex flex-col">
        <div>
          <h4 className="font-semibold text-center bg-slate-300">Penalty</h4>
        </div>
        <div className="flex justify-evenly">
          <div className="flex flex-col items-center w-1/3 text-center">
            <h3 className="w-full border border-slate-300">Scored</h3>
            <p className="w-full border border-slate-300">
              {teamStatistics?.penalty.scored.total}
            </p>
          </div>
          <div className="flex flex-col items-center w-1/3 text-center">
            <h3 className="w-full border border-slate-300">Missed</h3>
            <p className="w-full border border-slate-300">
              {teamStatistics?.penalty.missed.total}
            </p>
          </div>
          <div className="flex flex-col items-center w-1/3 text-center">
            <h3 className="w-full border border-slate-300 ">Total</h3>
            <p className="w-full border border-slate-300">
      ...
      <section className="flex flex-col">
        <div>
          <h4 className="font-semibold text-center bg-slate-300">Cards</h4>
        </div>
        <div className="flex justify-evenly">
