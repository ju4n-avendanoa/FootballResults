      ...
      {details && (
        <>
          ...
          <section className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white h-2/3  w-1/2 z-20 overflow-auto">
            ...
            <section className="flex justify-around items-center h-1/3">
              <div className="w-1/4 flex justify-center h-full p-2 border-r border-black bg-slate-300">
                <Image
                  src={team!.team.logo}
                  alt="team-logo"
                  width={120}
              ...
              <article className="w-1/4 h-full flex flex-col justify-evenly p-4 border-r border-black text-xs">
                <h4>
              ...
              <div className="flex items-center w-1/4 h-full border-r border-black bg-slate-300">
                <Image
              ...
              <article className="flex flex-col justify-evenly w-1/4 h-full p-4 text-xs">
                <h4>
                ...
                <section className="flex flex-col">
                  ...
                  <div className="flex justify-evenly">
                    <div className="flex flex-col items-center w-1/3 border border-slate-300">
                      <h3 className="bg-green-300 w-full text-center">Wins</h3>
                    ...
                    <div className="flex flex-col items-center w-1/3 border border-slate-300">
                      <h3 className="bg-red-300 w-full text-center"> Losses</h3>
                ...
                <section className="flex flex-col">
                  ...
                  <div className="flex justify-evenly">
                    <div className="flex flex-col items-center w-1/3 text-center">
                      <h3 className="border border-slate-300 w-full">Scored</h3>
                      <p className="border border-slate-300 w-full">
                        {teamStatistics?.penalty.scored.total}
                      </p>
                    </div>
                    <div className="flex flex-col items-center w-1/3 text-center">
                      <h3 className="border border-slate-300 w-full">Missed</h3>
                      <p className="border border-slate-300 w-full">
                        {teamStatistics?.penalty.missed.total}
                      </p>
                    </div>
                    <div className="flex flex-col items-center w-1/3 text-center">
                      <h3 className="border border-slate-300 w-full ">Total</h3>
                      <p className="border border-slate-300 w-full">
